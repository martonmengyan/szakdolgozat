...
Ezek az adatok a blockok típusát fejezi ki, amelyek ]0,2[ nyílt intervallumon belüli számok jelölnek.
...
\begin{itemize}
    \item Erő(str): ]0,1[
    \item Kitartás(vit): ]0,1[
    \item Kitérés(eva): ]0,1[
    \item Pontosság(acc): ]0,1[
\end{itemize}
...
Ha nagyobb a támadó ágens acc értéke, mint a támadott eva értéke, akkor 100\%-osan betalál a sebzése.
Ha nem nagyobb, akkor 20\% esélye van arra a támadott félnek, hogy ne kapjon semmilyen sebzést.
...
Ha nagyobb a támadó ágens str értéke, mint a támadott vit értéke, akkor 20\% esélye van arra a támadó félnek, hogy dupla sebzést mérjen be.
Ha nem nagyobb, akkor fixen 1 sebzést okoz a támadása.
...
\begin{itemize}
    ...
    \item A balra, jobbra, felfelé és lefelé irányban érzékelnek 2 blocknyi távolságra.
\end{itemize}
...
A következő ábrán látható az ágens cselekvésének meghatározására szolgáló ciklus, amely a szimuláció kezdetétől működik. ~\ref{fig:agentfunction}
...
Map teljesítéséhez szükséges tárgy, amely egy Chest. A Kék faction-nek a kék chestet, a piros faction-nek a piros chestet kell elérnie.
...
Az Brick egy oszlop, amely a map generáláskor kerülnek bizonyos cellákra.
